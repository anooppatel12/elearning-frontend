    ...
    <div className="course-card">
        ...
        <p>Price- 	&#8377;{course.price}</p>
        {
          isAuth? ( 
            ...
            <>
            {
              user.subscription.includes(course._id)?(<button onClick={()=>navigate(`/course/study/${course._id}`)} className='common-btn'>Learn</button>):(
            ...
            <button onClick={()=>navigate('/login')} className='common-btn'>Login to Enroll</button>
          )
        }
        <br />
